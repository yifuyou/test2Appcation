...
public class Banner<T, BA extends BannerAdapter<T>> extends FrameLayout implements BannerLifecycleObserver {
     ...
     * 设置点击事件
     */
    public Banner setOnBannerListener(OnItemClickInterface listener) {
        if (getAdapter() != null) {
            getAdapter().setOnItemClickCallback(listener);
        }
        return this;
    }
