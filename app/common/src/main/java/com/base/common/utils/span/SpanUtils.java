...
public final class SpanUtils {
    ...
    private final int mTypeEmoji = 3;
    ...
    public SpanUtils appendEmoji(@NonNull final Drawable drawable,String emojiCode) {
        apply(mTypeEmoji);
        this.imageDrawable = drawable;
        this.alignImage = ALIGN_BOTTOM;
    ...
    public SpanUtils appendEmoji(@DrawableRes final int resourceId,String emojiCode) {
        apply(mTypeEmoji);
        this.imageResourceId = resourceId;
        this.alignImage = ALIGN_BOTTOM;
        this.emojiCode = emojiCode;
...
//            }
    ...
    public static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(BaseApp.getApplication().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            BaseApp.getApplication().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(BaseApp.getApplication().getResources(), bitmap);
                    drawable.setBounds(
                    ...
                    try {
                    drawable = ContextCompat.getDrawable(BaseApp.getApplication(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
