...
public class ImeDelBugFixedEditText extends AppCompatEditText {
    ...
    private ImeDelBugFixedEditText.OnDelKeyEventListener delKeyEventListener;
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        return new ImeDelBugFixedEditText.ZanyInputConnection(super.onCreateInputConnection(outAttrs), true);
    }
    ...
    public void setDelKeyEventListener(ImeDelBugFixedEditText.OnDelKeyEventListener delKeyEventListener) {
