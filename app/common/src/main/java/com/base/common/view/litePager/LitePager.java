...
public class LitePager extends ViewGroup implements Runnable {
    ...
    private boolean isSlide = true;//是否可以滑动  不能滑动时也不能自动滚动
    ...
    public void setSelection(int index) {
        if (getChildCount() - 1 == index || getChildCount() == 0 || (mAnimator != null && mAnimator.isRunning() && !isNeedPlayTwice)) {
            return;
        }
...
//                LogUtil.d("tag_first currentValue ", String.valueOf(currentValue));
                onItemMove();
            }
        });
            ...
            if (isReordered) {
                if (is5Child()) {
                    ...
                    if (getChildCount() == 8) {
                        ...
                        if (mOffsetPercent > 0) {
//                            reOrder(7, 0, 1, 2, 3, 4, 5, 6);
                            reOrder(1, 7, 0, 2, 3, 4, 5, 6);
                        } else {
//                            reOrder(1, 2, 3, 4, 5, 6, 7, 0);
                            reOrder(2, 0, 3, 4, 5, 6, 7, 1);
                        }
                    } else {
                        if (mOffsetPercent > 0) {
                ...
                if (getChildCount() == 8) {
                    switch (lp.from) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            lp.to = mOffsetPercent > 0 ? 2 : 4;
                            break;
                        case 4:
                            lp.to = mOffsetPercent > 0 ? 3 : 5;
                            break;
                        case 5:
                            lp.to = mOffsetPercent > 0 ? 4 : 6;
                            break;
                        case 6:
                            lp.to = mOffsetPercent > 0 ? 5 : 7;
                            break;
                        case 7:
                            lp.to = mOffsetPercent > 0 ? 6 : 0;
                            break;
                        default:
                            break;
                    }
...
//        removeCallbacks(this);
    ...
    private boolean handleActionUp(float x, float y) {
        ...
        if (Math.abs(offsetX) < mTouchSlop && Math.abs(offsetY) < mTouchSlop) {
            ...
            if (hitView != null) {
                ...
                int count = is5Child() ? 4 : getChildCount() == 8 ? 7 : 2;

                if (indexOfChild(hitView) == (count)) {
            ...
            switch (lp.from) {
                case 0:
                    switch (lp.to) {
                        ...
                        case 5:
                        case 6:
                            baseLine = start + (int) ((end - start) * -mOffsetPercent);  //从左边滑到最右边
                            break;
                        case 7:
                            baseLine = start + (int) ((middle - start) * mOffsetPercent);  //从左边滑到中间
                            break;
                        default:
                            baseLine = start;   //默认在开始位置
                            break;
                    }
                    break;
                case 1:
                    switch (lp.to) {
                        case 0:
                            baseLine = end + (int) ((end - start) * -mOffsetPercent/*因为是反方向*/);  //从右边滑到左边
                            break;
                        default:
                            baseLine = end;   //位置不变还是在右边
                            break;
                    }
                    break;
                case 2:
                ...
                case 4:
                case 5:
                    baseLine = end;//在右边的中间不会有位移
                    break;
                case 6:
                    switch (lp.to) {
                        case 7:
                            baseLine = end + (int) ((end - middle) * mOffsetPercent);//从右边到中间
                            break;
                        default:
                            baseLine = end;
                            break;
                ...
                case 7:
                    switch (lp.to) {
                        case 0:
                            baseLine = middle + (int) ((middle - start) * mOffsetPercent); //中间到左边
                            break;
                        case 6:
                            baseLine = middle + (int) ((end - middle) * mOffsetPercent);   //中间到右边
                            break;
                        default:
                            baseLine = middle;
                            break;
    ...
    private void setTopOrder(int index) {
