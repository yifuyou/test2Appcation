...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private static final int DEFAULT_LINECOLOR = 0xffEFEFEF;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLineWidth = (int) ta.getDimension(R.styleable.GridPasswordView_gpvLineWidth, getResources().getDimensionPixelSize(R.dimen.dp_1));
