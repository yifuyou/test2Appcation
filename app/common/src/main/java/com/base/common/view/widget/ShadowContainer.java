...
public class ShadowContainer extends ViewGroup {
    ...
    public ShadowContainer(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int shadowColor = a.getColor(R.styleable.ShadowContainer_shadowColor, Color.GRAY);
//        int shadowColor = Color.RED;
        float shadowRadius = a.getDimension(R.styleable.ShadowContainer_shadowRadius, 0);
        deltaLength = a.getDimension(R.styleable.ShadowContainer_shadowDeltaLength, 0);
        cornerRadius = a.getDimension(R.styleable.ShadowContainer_shadowCornerRadius, 0);
        float dx = a.getDimension(R.styleable.ShadowContainer_shadowDx, 0);
        float dy = a.getDimension(R.styleable.ShadowContainer_shadowDy, 0);
