...
/**
  中间有间隔但是两侧没有
 */
public class ItemGridDividerDecoration extends RecyclerView.ItemDecoration {

    private Drawable mDivider = null;
    private Paint mPaint = null;
    private int mDividerHeight = 1;//分割线高度，默认为1px

    public ItemGridDividerDecoration(Context context) {
        mDivider = ContextCompat.getDrawable(context, R.color.C_DBDBDB);
        mDividerHeight = mDivider != null ? mDivider.getIntrinsicHeight() : 1;
    }

    public ItemGridDividerDecoration(int dividerHeight) {
     ...
     */
    public ItemGridDividerDecoration(Context context, @DrawableRes int drawableId) {
     ...
     */
    public ItemGridDividerDecoration(int dividerHeight, @ColorRes int dividerColor) {
        mDividerHeight = dividerHeight;
        // mDividerWidth = dividerHeight;
