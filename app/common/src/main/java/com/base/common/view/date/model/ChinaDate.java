package com.base.common.view.date.model;
...
public class ChinaDate {
    ...
    private final static String[] yearUps = new String[]{"〇","一","二","三","四","五","六","七","八","九"};
    ...
    public static ArrayList<String> getUpYears(int startYear, int endYear){
        ArrayList<String> years = new ArrayList<>();
        for(int i= startYear;i<endYear;i++){
            String s = String.valueOf(i);
            StringBuilder stringBuilder = new StringBuilder();
            for (int i1 = 0; i1 < s.length(); i1++) {
                stringBuilder.append(yearUps[Integer.parseInt(s.substring(i1,i1+1))]);
            }

            years.add(stringBuilder.toString());
        }
        return years;
    }
