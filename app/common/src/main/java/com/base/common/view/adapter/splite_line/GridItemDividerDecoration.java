...
public class GridItemDividerDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public GridItemDividerDecoration(Context context, @DrawableRes int drawableId) {
     ...
     */
    public GridItemDividerDecoration(int dividerHeight, @ColorRes int dividerColor) {
        mDividerHeight = dividerHeight;
        // mDividerWidth = dividerHeight;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        boolean lastRow = isLastRaw(parent, itemPosition, spanCount, childCount);
        ...
        if (spanCount >= childCount) {
            ...
            if (itemPosition == childCount - 1) {
                ...
                outRect.set(mDividerHeight, mDividerHeight, 0, mDividerHeight);
            }
        } else if (lastRow && lastColum) {
            outRect.set(mDividerHeight, mDividerHeight, mDividerHeight, mDividerHeight);
        } else if (lastRow)// 如果是最后一行，需要绘制底部
        {
            outRect.set(mDividerHeight, mDividerHeight, 0, mDividerHeight);
        } else if (lastColum)// 如果是最后一列，需要绘制右边
        {
