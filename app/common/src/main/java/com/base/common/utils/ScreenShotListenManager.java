...
public class ScreenShotListenManager {
     ...
     * 注册截屏监听
     */
    public static ScreenShotListenManager registerScreenShotListener(Activity context, ScreenShotListenManager.OnScreenShotListener listener) {
        ScreenShotListenManager screenShotListenManager = ScreenShotListenManager.newInstance(context);
        screenShotListenManager.setListener(listener);
//        new ScreenShotListenManager.OnScreenShotListener() {
//            public void onShot(String imagePath) {
//                if (isScreenShotListen) {
//                    // do something
//                    UIUtils.showToastSafes("截屏了");
//                }
//            }
//        }
        ...
        if (Build.VERSION.SDK_INT > 22) {
            ...
            if (permissionList.size() != 0) {
                ActivityCompat.requestPermissions(context, permissionList.toArray(new String[permissionList.size()]), 0);
            }
        } else {
            // 开始截图监听
            screenShotListenManager.startListen();
     ...
     * 是否监听截屏
     *
     * @param screenShotListen
     */
    public void setScreenShotListen(boolean screenShotListen) {
        isScreenShotListen = screenShotListen;
    }

    public boolean isScreenShotListen() {
        return isScreenShotListen;
    }
    ...
    private ScreenShotListenManager(Context context) {
        ...
        if (sScreenRealSize == null) {
            ...
            if (sScreenRealSize != null) {
                LogUtil.e(TAG, "Screen Real Size: " + sScreenRealSize.x + " * " + sScreenRealSize.y);
            } else {
                LogUtil.e(TAG, "Get screen real size failed.");
            }
        }
    }
    ...
    public void startListen() {
        assertInMainThread();
        if (sHasCallbackPaths != null) sHasCallbackPaths.clear();
