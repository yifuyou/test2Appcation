...
public class LoginGestureView extends ViewGroup {
    ...
    public LoginGestureView(@NonNull Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public LoginGestureView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public LoginGestureView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public LoginGestureView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        if (nodeSize > 0) {
            isSettingMode = true;
            nodeOnSrc.setBounds(0,0,(int)nodeSize,(int)nodeSize);
            nodeErrorOnSrc.setBounds(0,0,(int)nodeSize,(int)nodeSize);
            nodeSrc.setBounds(0,0,(int)nodeSize,(int)nodeSize);
        }
        // 初始化振动器
        ...
        for (int n = 0; n < 9; n++) {
            ...
            node.setLayoutParams(new ViewGroup.LayoutParams((int)nodeSize,(int)nodeSize));
            addView(node);
        }
...
//                        float radius = getContext().getResources().getDimension(R.dimen.small_icon_radius);
                        float radius =nodeSize==0?24:nodeSize/2;
