...
import com.base.common.view.date.tools.LinearGradient;
...
public class WheelPicker<T> extends View {
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		Log.e("onsize",mSelectedItemPaint.ascent()+" .."+ mSelectedItemPaint.descent());
		Log.e("mItemHeight",mItemHeight +"、、");
		 // 文字中间到基线的距离
//		mItemHeight/2 +(fontMetrics.descent - fontMetrics.ascent) / 2 -fontMetrics.descent  72
		// 下面这个式子也等于72  基线应该是正数
...
//
    ...
    public void setCurrentPositionNoSmooth(int currentPosition){
