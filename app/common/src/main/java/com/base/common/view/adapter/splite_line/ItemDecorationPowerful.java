...
public class ItemDecorationPowerful extends RecyclerView.ItemDecoration {
    ...
    private boolean isDefault = true;//是否是默认的四周不添加分隔线

    private boolean isGroupDefault = true;//分组是否是默认的四周不添加分隔线
    ...
    public ItemDecorationPowerful(int orientation) {
        this(orientation, Color.parseColor("#00000000"), 1);
    }
     ...
     */
    public ItemDecorationPowerful(int orientation, @ColorInt int color, int divWidth) {
    ...
    /**
     * @param aDefault true 四周不添加分隔线  false  四周添加分隔线
     */
     ...
     * 对有分组的有效
     *
     * @param groupDefault true 分组的四周不添加分隔线  false  分组的四周添加分隔线
     */
