...
public class DragAndSwipeCallback extends ItemTouchHelper.Callback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState == ItemTouchHelper.ACTION_STATE_DRAG
            ...
            viewHolder.itemView.setTag(R.id.tag_two, true);
        }
    ...
    public void clearView(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getTag(R.id.tag_first) != null
                && (Boolean) viewHolder.itemView.getTag(R.id.tag_first)) {
            if (mDraggableModule != null) {
                mDraggableModule.onItemDragEnd(viewHolder);
            }
            viewHolder.itemView.setTag(R.id.tag_first, false);
        }
        if (viewHolder.itemView.getTag(R.id.tag_two) != null
                && (Boolean) viewHolder.itemView.getTag(R.id.tag_two)) {
            if (mDraggableModule != null) {
                mDraggableModule.onItemSwipeClear(viewHolder);
            }
            viewHolder.itemView.setTag(R.id.tag_two, false);
        }
    }
