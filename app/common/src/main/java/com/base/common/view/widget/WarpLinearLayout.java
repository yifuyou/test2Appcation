...
public class WarpLinearLayout extends ViewGroup {
    ...
    private final static class Type {
        ...
        Type(Context context, AttributeSet attrs) {
            ...
            gravity = typedArray.getInt(R.styleable.WarpLinearLayout_wl_gravity, gravity);
            horizontal_Space = typedArray.getDimension(R.styleable.WarpLinearLayout_wl_horizontal_Space, horizontal_Space);
            vertical_Space = typedArray.getDimension(R.styleable.WarpLinearLayout_wl_vertical_Space, vertical_Space);
            isFull = typedArray.getBoolean(R.styleable.WarpLinearLayout_wl_isFull, isFull);
        }
    }
